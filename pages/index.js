                ...
                <div>
                  ...
                  <div className='mt-5 text-2xl font-large  text-transparent bg-gradient-to-r from-blue-500 via-indigo-400 to-purple-600 bg-clip-text md:nt-3'>
                    ...
                    <div className='flex items-center mt-4 space-x-6 md:mt-4'>
                      <motion.a href="https://github.com/mhndsbgyn" target={"_blank"} rol="noopener noreferrer" className='flex items-center justify-center text-gray-800 transition-colors duration-300 dark:text-gray-100 dark:hover:text-blue-500 hover:text-blue-500'
                       whileHover={{scale:1.2}}>
                        <Github className={"w-8 h-8 fill-current"} />
                      </motion.a>
                       
                      <motion.a href="https://www.linkedin.com/in/gzmcndmrr/" target={"_blank"} rol="noopener noreferrer" className='flex items-center justify-center text-gray-800 transition-colors duration-300 dark:text-gray-100 dark:hover:text-blue-500 hover:text-blue-500'
                       whileHover={{scale:1.2}}>
                        <Linkedin className={"w-8 h-8 fill-current"} />
                      </motion.a>
                       
                      <motion.a href="https://twitter.com/Gizem38030017" target={"_blank"} rol="noopener noreferrer" className='flex items-center justify-center text-gray-800 transition-colors duration-300 dark:text-gray-100 dark:hover:text-blue-500 hover:text-blue-500'
                       whileHover={{scale:1.2}}>
